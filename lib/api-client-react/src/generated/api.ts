...
export const getVaultStatus = async ( options?: RequestInit): Promise<VaultStatus> => {
...
export const getCreateVaultInvestmentUrl = () => {
  ...
  return `/api/vault/invest`
}

export const createVaultInvestment = async (vaultInvestInput: VaultInvestInput, options?: RequestInit): Promise<SuccessResponse> => {

  return customFetch<SuccessResponse>(getCreateVaultInvestmentUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateVaultInvestmentMutationOptions = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createVaultInvestment>>, TError,{data: BodyType<VaultInvestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createVaultInvestment>>, TError,{data: BodyType<VaultInvestInput>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createVaultInvestment>>, {data: BodyType<VaultInvestInput>}> = (props) => {
          const {data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateVaultInvestmentMutationBody = BodyType<VaultInvestInput>
    export type CreateVaultInvestmentMutationError = ErrorType<ErrorResponse>

    export const useCreateVaultInvestment = <TError = ErrorType<ErrorResponse>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createVaultInvestment>>, TError,{data: BodyType<VaultInvestInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createVaultInvestment>>,
        TError,
        {data: BodyType<VaultInvestInput>},
        TContext
      > => {
      return useMutation(getCreateVaultInvestmentMutationOptions(options));
    }

export const getRedeemVaultInvestmentUrl = () => {
