  ...
  return (
    <LegalLayout title="About Us">
      <div className="flex flex-col items-center text-center py-2">
        <QuantumLogo className="w-16 h-16 mb-4" />
        <h2 className="text-lg font-bold text-foreground">Quantum FX Bot</h2>
      ...
      <section>
        <h2>Our mission</h2>
        <p>
          Quantum FX Bot was founded in 2023 with a simple goal: give everyday
      ...
      <section>
        ...
        <p>
          ...
          Reach us anytime at{" "}
          <span className="text-primary">support@quantumfxbot.com</span> or
