...
export function QuantumLogo({ className }: QuantumLogoProps) {
  return (
    <svg
      viewBox="0 0 100 100"
      fill="none"
      ...
      className={className}
      role="img"
      aria-label="Quantum FX Bot logo"
    >
      <defs>
        <linearGradient id="qfx-grad" x1="20" y1="14" x2="80" y2="86" gradientUnits="userSpaceOnUse">
